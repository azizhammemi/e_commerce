...
$search=$_POST['recherche'];
  $sql="SELECT * from contact WHERE nom  like '%$search%' or email like '%$search%' ";
}else
                ...
                <div class="col-xl-3 col-lg-2">
                 ...
                 <div class="col-xl-6 col-lg-7">
                    <nav class="header__menu">
                     ...
                     <li class="active"><a href="listContact.php">contact</a> </li>
                        </ul>
                    </nav>
                </div>
                <div class="col-lg-3">
...
?>
   ...
   <center> Rechercher un contact : <input type="text" name="recherche" placeholder="cherchez avec nom">
     <input type="SUBMIT" value="cherchez" class="b"> </center> 
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Liste contact</h2>
				</div>
			</div>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Liste des contact</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
         ...
         <tr> <td> ID </td> <td> Nom </td> <td> email ou phone </td><td> message </td><td>Opérations</td>
                              </tr>
                  ...
                  <?php while($row = mysqli_fetch_object($res)) {?>
                    ...
                    <td><a href="deletecontact.php?id=<?php echo $row->id ?>">Supprimer</a></td>
         ...
         <center> <a href="exportcontactxl.php"><button class="b">export excel</button></a></center>  
